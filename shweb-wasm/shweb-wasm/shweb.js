...
export class Generator {
     ...
     */
    constructor(config) {
        const ret = wasm.generator_new(config);
    ...
    generate_batch(batch_size) {
        const ret = wasm.generator_generate_batch(this.__wbg_ptr, batch_size);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('shweb_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
